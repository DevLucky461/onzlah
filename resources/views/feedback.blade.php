...
<div class="container-fluid scroller">
    <div class="row main-header-bg" style="padding-top:5rem">
        <div class="col-2 text-left flex-center pb-3">
            <a href="/profile"><img src="{{url('/assets2/icon/left-arrow.png')}}" alt=""></a>
        </div>
        <div class="col-10 text-left ">
            <p class="font-Montserrat-ExtraBold font-size-28px FFEF41-color ">MY COMMUNITY</p>
        </div>
    </div>
    ...
    <form action="/create_feedback" method="post">
        ...
        <div class="row p-2 font-color-black">
            <div class="col-12">
                <p class="font-NunitoSans-Regular font-size-16px pt-20px">
                    Share your feedback to us. We may featured your words on our social media platform and you can get FREE 1 <img src="{{asset('/img/life.png')}}" width="15" height="15" alt="">.
                </p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="col-12 text-center pb-5 mt-15px">
            <button class="btn bg-yellow-content font-size-30px font-Montserrat-Bold btn-block feedback-submit">SUBMIT</button>
        </div>
    </form>
</div>
@endsection