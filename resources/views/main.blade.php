...
@endsection
@section('content')
<div class="text-white scroller" style="width: 100%;">
    <div class="container-fluid main-header-bg pb-10">
        <div class="row">
            <div class="col-6">
                <div class="position-relative w-100" style="height:6rem">
                ...
                <div class="position-relative w-100 " style="height:6rem">
                    <div class="position-absolute w-100 " style="bottom: 0">
                        <div class="d-flex justify-content-between">
                            <a href="/scoreboard"><img src="{{url('/assets2/icon/surface1.png')}}" alt=""></a>
                            <a href="/qr"><img src="{{url('/assets2/icon/Group 22597.png')}}" alt=""></a>
                            <a href="/my-friends"><img src="{{url('/assets2/icon/Path 100340.png')}}" alt=""></a>
                            <a href="/notification">
                                <div class="notification-box text-white text-center " style="padding-top:2px">
                                    {{$noti}}
    ...
    <div class="container-fluid menu-height ">
        <div class="row">
            <div class="bg-white menu-border">
                        ...
                        <div class="col-12 view-more" style="display: none;">
                            <div class="input-sharp d-flex mt-3 bg-lime" style="border-style: solid;">
                                <div class="col-6 my-3 text-black font-NunitoSans-ExtraBold">
                                    ...
                                    @foreach(json_decode($e->view_more_data, true) as $key => $value)
                                        @if ($key == 'kol')
                                            @foreach($value as $kv => $kvalue)
                                                @if ($kv == 'name')
                                                <p class="m-0 p-0">Hosted by: {{$kvalue}}</p>
                                                <div class="pb-20px d-flex">
                                                @endif

                                                    @if ($kv == 'facebook')
                                                    <div class="col-3 p-0">
                                                        <a class="social-link" href="{{$kvalue}}"><div class="view-more-icon bg-fb"></div></a>
                                                    </div>
                                                    @elseif ($kv == 'twitter')
                                                    <div class="col-3 p-0">
                                                        <a class="social-link" href="{{$kvalue}}"><div class="view-more-icon bg-whatsapp"></div></a>
                                                    </div>
                                                    @elseif ($kv == 'youtube')
                                                    <div class="col-3 p-0">
                                                        <a class="social-link" href="{{$kvalue}}"><div class="view-more-icon bg-twitter"></div></a>
                                                    </div>
                                                    @elseif ($kv == 'web')
                                                    <div class="col-3 p-0">
                                                        <a class="social-link" href="{{$kvalue}}"><div class="view-more-icon bg-wechat"></div></a>
                                                    </div>
                                                    @endif
                                            @endforeach
                                            </div>
                                        ...
                                        @if ($key == 'sponsor')
                                            @foreach($value as $kv => $kvalue)
                                                @if ($kv == 'name')
                                                <p class="p-0 m-0">Sponsored by: {{$kvalue}}</p>
                                                <div class="pb-20px d-flex">
                                                @endif
                                        ...
                                        @if ($key == 'brand')
                                            @foreach($value as $kv => $kvalue)
                                                @if ($kv == 'name')
                                                <p class="p-0 m-0">Brand: {{$kvalue}}</p>
                                                <div class="pb-20px d-flex">
                                                @endif
