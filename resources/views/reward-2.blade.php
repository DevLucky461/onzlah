...
<div class="container-fluid scroller pb-3" style="background-color: #EAEAEA">
    <div class="row pt-5 purple-header redeem-bg-header bg-violet text-white">
        <div class="col-4">
            <a href="/"><img src="{{url('images/onzlah-logo-small.png')}}" alt=""></a> 
        </div>
        <div class="col-3">
            <div class="header-menu font-Montserrat font-size-20px">
               <a class="FFEF41-color text-deco-none redeem-list redeem-tabs-bb" href="/redeem" class="text-underline">LIST</a>
            </div>
        </div>
        <div class="col-5">
            <div class="header-menu font-Montserrat font-size-20px">
                <a class="FFEF41-color text-deco-none redeem-myredeems" href="/voucher/{{auth()->user()->id}}">MY REDEEMS</a>
            </div>
        </div>
    </div>
    <div class="row" style="background-color: white">
        <div class="col-12 text-center text-black font-size-20px font-Montserrat-Bold">
            <div class="py-3"> 
            My Coins: <img src="{{url('images/coin-icon.svg')}}"> {{number_format(auth()->user()->coins)}}
            </div>
        </div>
    </div>
    <div class="row">
    ...
    @foreach($reward as $r)
        <div class="row bg-white mb-3 redeem-border">
            ...
            @endswitch
            ">
                <a href="/reward-details/{{$r->id}}" style="color: black"><p class="font-NunitoSans-ExtraBold">{{$r->reward_name}}</p></a>
                        ...
                        $('#reward-container')
                            .append($('<div/>').addClass('row bg-white mb-3 redeem-border')
                                ...
                                .append($('<div/>').addClass('col-8 font-color-black text-bold font-size-15px p-3 redeem-bg-'+response.reward[i].reward_type)
                                    .append($('<a>').attr({
                                            'href': '/reward-details/'+response.reward[i].id,
                                            'style': 'color: black;',
                                        })
