...
<div class="container-fluid scroller pb-3" style="color: black;">
    <div class="row">
        ...
        <a href="/api/viewRedeemPage/{{$user->id}}" class='m-3 btn font-Montserrat-Bold font-size-18px input-sharp redeem-bg-deals'>Back</a>
        </div>
    </div>
    <div class="row pt-3">
        <div class="col-12">
            <button class='mb-3 btn font-Montserrat-Bold font-size-18px input-sharp redeem-bg-{{$r->reward_type}}'>{{Str::ucfirst($r->reward_type)}}</button>
...
<div class="modal fade scroller" id="redeem-modal">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content mx-4">
            ...
            <button id='confirm-button' class="btn details-avail-box font-size-13px text-black border-radius-0px h-65px w-65px m-8px"  style="background-color: #00FE45">
            <img src="{{url('/images/reward/tick.png')}}" alt="">
            </button>
            
            <button id='decline-button' class="confirmationbtn details-avail-box font-size-13px text-black bg-white border-radius-0px h-65px w-65px m-8px" data-dismiss="modal">
